...
public class ASTXMLSerialization extends ASTSerialization {

  protected final XStream xstream;

  public ASTXMLSerialization() {
  ...
  public void serialize(ASTNode node, String fileName) {
    try {
      ...
      xstream.marshal(node, streamWriter);
    } catch (IOException e) {
  ...
  public ASTNode deserialize(String fileName) {
    try {
      ...
      return (ASTNode) xstream.fromXML(reader);
