...
public class ASTVisualizerVisitor extends ASTNodeBaseVisitor<VisualizerNode, Object> {
  ...
  private HashMap<VisualizerNode, String> recordsRefs;
  private HashMap<String, VisualizerNode> records;
  ...
  private void hookRecordRefs() {
    for (VisualizerNode ref : recordsRefs.keySet()) {
      String name = recordsRefs.get(ref);
      VisualizerNode def = records.get(name);
      addRefEdge(ref, def, getColor());
    }
  }
  ...
  public VisualizerNode visitModule(Module module, Object obj) {
    ...
    for (RecordTypeDeclaration r : module.getRecords()) {
      VisualizerNode sub = r.accept(this, null);
      addEdge(vn, sub);
    }
    return vn;
  }
    ...
    VisualizerNode vn =
        addNode(
            "Function\\n"
                ...
                + "\\n"
                + functionNode.getReturnType().toString(),
            null);
  ...
  @Override
  public VisualizerNode visitIteratorDeclaration(
      IteratorDeclaration iteratorDeclaration, Object obj) {
    return visitDeclaration(
        iteratorDeclaration,
        addNode((iteratorDeclaration.isVariable() ? "VarIterator" : "ValIterator"), null));
  }

  @Override
  public VisualizerNode visitRecordTypeDeclaration(
      RecordTypeDeclaration recordTypeDeclaration, Object obj) {
    ...
    if (decorated) records.put(recordTypeDeclaration.getName(), vn);
    return vn;
  }

  @Override
  public VisualizerNode visitRecordElementDeclaration(
      RecordElementDeclaration recordElementDeclaration, Object obj) {
    return visitDeclaration(
        recordElementDeclaration,
        addNode((recordElementDeclaration.isVariable() ? "VarElement" : "ValElement"), null));
  }
  ...
  public VisualizerNode visitDeclaration(Declaration declaration, Object obj) {
    ...
    if (decorated) {
      if (declaration.getType() instanceof RecordType) {
        recordsRefs.put(vn, declaration.getType().toString());
      }
    }
    return vn;
  }
  ...
  public VisualizerNode visitValueDefinition(ValueDefinition valueDefinition, Object obj) {
    return visitDeclaration(valueDefinition, addNode("ValDef", null));
  }

  @Override
  public VisualizerNode visitVariableDeclaration(
      VariableDeclaration variableDeclaration, Object obj) {
    return visitDeclaration(variableDeclaration, addNode("VarDecl", null));
  }
  ...
  private void handleLHSCommon(LeftHandIdentifier leftHandIdentifier, VisualizerNode vn) {
    ...
    if (leftHandIdentifier.getDeclaration() != null) {
      addRefEdge(
          vn,
          declarations.get(leftHandIdentifier.getDeclaration()),
          colors.get(leftHandIdentifier.getDeclaration()));
    }
  }
  ...
  @Override
  public VisualizerNode visitMatrixLHSIdentifier(
      MatrixLHSIdentifier matrixLHSIdentifier, Object obj) {
  ...
  @Override
  public VisualizerNode visitVectorLHSIdentifier(
      VectorLHSIdentifier vectorLHSIdentifier, Object obj) {
  ...
  @Override
  public VisualizerNode visitRecordLHSIdentifier(
      RecordLHSIdentifier recordLHSIdentifier, Object obj) {
    VisualizerNode vn = addNode("RecordLHSId", null);
    handleLHSCommon(recordLHSIdentifier, vn);
    VisualizerNode element = addNode("Element", null);
    VisualizerNode elementSub = addNode(recordLHSIdentifier.getElementName(), null);
    addEdge(vn, element);
    addEdge(element, elementSub);
    return vn;
  }
  ...
  public VisualizerNode visitForEachLoop(ForEachLoop forEachLoop, Object obj) {
    VisualizerNode vn = addNode("ForEach", null);
  ...
  public VisualizerNode visitSwitchStatement(SwitchStatement switchStatement, Object obj) {
    ...
    VisualizerNode testExpr = addNode("Test", null);
    addEdge(vn, testExpr);
    addEdge(testExpr, switchStatement.getTestExpression().accept(this, null));
  ...
  public VisualizerNode visitSingleCase(SingleCase singleCase, Object obj) {
    ...
    if (!singleCase.isDefault()) {
      ...
      VisualizerNode test =
          addNode("Condition : " + ((Case) singleCase).getCondition(), Type.getIntType());
      ;
      addEdge(vn, test);
    } else {
  ...
  @Override
  public VisualizerNode visitMatrixMultiplication(
      MatrixMultiplication matrixMultiplication, Object obj) {
    return visitBinaryExpression(
        matrixMultiplication, addNode("#", matrixMultiplication.getType()));
  }
  ...
  public VisualizerNode visitCompare(Compare compare, Object obj) {
    return visitBinaryExpression(
        compare, addNode("\\" + compare.getComparator().getOperator(), compare.getType()));
  }
  ...
  @Override
  public VisualizerNode visitRecordElementSelect(
      RecordElementSelect recordElementSelect, Object obj) {
    ...
    VisualizerNode select =
        addNode(recordElementSelect.getElementName(), recordElementSelect.getType());
    addEdge(vn, struct);
    addEdge(vn, select);
    return vn;
  }
  ...
  public VisualizerNode visitRecordInit(RecordInit recordInit, Object obj) {
    VisualizerNode vn = addNode("RecordInit", recordInit.getType());
    for (Expression exp : recordInit.getElements()) {
      VisualizerNode name = exp.accept(this, null);
      addEdge(vn, name);
    }
    if (decorated) {
      recordsRefs.put(vn, recordInit.getType().toString());
    }
    return vn;
  }
  ...
  @Override
  public VisualizerNode visitIdentifierReference(
      IdentifierReference identifierReference, Object obj) {
    VisualizerNode vn = addNode("Identifier", null);
    VisualizerNode id =
        addNode(identifierReference.getIdentifierName(), identifierReference.getType());
    if (identifierReference.getDeclaration() != null)
      addRefEdge(
          vn,
          declarations.get(identifierReference.getDeclaration()),
          colors.get(identifierReference.getDeclaration()));
    addEdge(vn, id);
    return vn;
  }
