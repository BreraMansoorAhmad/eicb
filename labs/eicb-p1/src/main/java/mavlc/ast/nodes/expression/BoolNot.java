...
public class BoolNot extends UnaryExpression {
  ...
  /** */
  private static final long serialVersionUID = 1440820668551796806L;
   ...
   */
  public BoolNot(int sourceLine, int sourceColumn, Expression operand) {
  ...
  public <RetTy, ArgTy> RetTy accept(ASTNodeVisitor<? extends RetTy, ArgTy> visitor, ArgTy obj) {
    return visitor.visitBoolNot(this, obj);
  }
}
