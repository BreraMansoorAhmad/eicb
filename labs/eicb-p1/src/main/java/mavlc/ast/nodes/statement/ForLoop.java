...
public class ForLoop extends Statement {
  ...
  public boolean equals(Object obj) {
    ...
    if (check == null) {
      if (other.check != null) return false;
    } else if (!check.equals(other.check)) return false;
    if (incrExpr == null) {
      if (other.incrExpr != null) return false;
    } else if (!incrExpr.equals(other.incrExpr)) return false;
    if (incrVarName == null) {
      if (other.incrVarName != null) return false;
    } else if (!incrVarName.equals(other.incrVarName)) return false;
    if (initValue == null) {
      if (other.initValue != null) return false;
    } else if (!initValue.equals(other.initValue)) return false;
    if (initVarName == null) {
      if (other.initVarName != null) return false;
    } else if (!initVarName.equals(other.initVarName)) return false;
    return true;
  }
