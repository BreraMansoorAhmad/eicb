...
/** AST-node representing the construction of a matrix or vector from the underlying values. */
public class StructureInit extends Expression {
  ...
  /**
   * Get the list of elements used for construction of this matrix or vector.
   *
