...
public class RecordTypeDeclaration extends ASTNode {
   ...
   * @param elements List of all record element declarations that are part of this record type
   *     declaration.
   */
  public RecordTypeDeclaration(
      int sourceLine, int sourceColumn, String name, List<RecordElementDeclaration> elements) {
   ...
   * @return The element with the specified name null, if name is null or no such element exists.
   */
