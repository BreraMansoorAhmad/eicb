...
public class IfStatement extends Statement {
   ...
   */
  public IfStatement(
      int sourceLine, int sourceColumn, Expression testExpression, Statement thenStatement) {
  ...
  public boolean equals(Object obj) {
    ...
    if (elseStatement == null) {
      if (other.elseStatement != null) return false;
    } else if (!elseStatement.equals(other.elseStatement)) return false;
    if (test == null) {
      if (other.test != null) return false;
    } else if (!test.equals(other.test)) return false;
    if (thenStatement == null) {
      if (other.thenStatement != null) return false;
    } else if (!thenStatement.equals(other.thenStatement)) return false;
    return true;
  }
}
