...
/** Abstract super-class of all declaration sites of referenceable entities. */
public abstract class Declaration extends Statement {
  ...
  /**
   * Get the offset from the local base of the surrounding frame for the declared entity.
   *
  ...
  /**
   * Set the offset from the local base of the surrounding frame for the declared entity.
   *
