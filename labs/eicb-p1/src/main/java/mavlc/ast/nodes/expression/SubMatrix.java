...
public class SubMatrix extends Expression {
  ...
  public SubMatrix(
      ...
      int sourceColumn,
      Expression struct,
      Expression XBaseIndex,
      Expression XStartIndex,
      Expression XEndIndex,
      Expression YBaseIndex,
      Expression YStartIndex,
      Expression YEndIndex) {
  ...
  public boolean equals(Object obj) {
    ...
    if (XBase == null) {
      if (other.XBase != null) return false;
    } else if (!XBase.equals(other.XBase)) return false;
    if (XEnd == null) {
      if (other.XEnd != null) return false;
    } else if (!XEnd.equals(other.XEnd)) return false;
    if (XStart == null) {
      if (other.XStart != null) return false;
    } else if (!XStart.equals(other.XStart)) return false;
    if (YBase == null) {
      if (other.YBase != null) return false;
    } else if (!YBase.equals(other.YBase)) return false;
    if (YEnd == null) {
      if (other.YEnd != null) return false;
    } else if (!YEnd.equals(other.YEnd)) return false;
    if (YStart == null) {
      if (other.YStart != null) return false;
    } else if (!YStart.equals(other.YStart)) return false;
    if (struct == null) {
