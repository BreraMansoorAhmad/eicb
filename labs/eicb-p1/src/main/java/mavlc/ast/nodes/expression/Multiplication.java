...
/**
 * AST-node representing a multiplication, including multiplications of a matrix or vector with a
 * skalar value and element-wise multiplications of matrices or vectors.
 */
