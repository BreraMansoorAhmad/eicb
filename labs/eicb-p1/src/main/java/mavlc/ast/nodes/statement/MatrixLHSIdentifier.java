...
public class MatrixLHSIdentifier extends LeftHandIdentifier {
   ...
   */
  public MatrixLHSIdentifier(
      int sourceLine, int sourceColumn, String variableName, Expression xIndex, Expression yIndex) {
  ...
  public boolean equals(Object obj) {
    ...
    if (xIndex == null) {
      if (other.xIndex != null) return false;
    } else if (!xIndex.equals(other.xIndex)) return false;
    if (yIndex == null) {
      if (other.yIndex != null) return false;
    } else if (!yIndex.equals(other.yIndex)) return false;
    return true;
  }
}
