...
public class Case extends SingleCase {
   ...
   * @param conditionExpr The constant expression whose value is compared against the surrounding
   *     switch statement's test expression.
   * @param statement The statement that is executed if the condition is equal to the test
   *     expression's value.
   */
