...
public class Function extends ASTNode {
  ...
  public boolean equals(Object obj) {
    ...
    if (functionBody == null) {
      if (other.functionBody != null) return false;
    } else if (!functionBody.equals(other.functionBody)) return false;
    if (name == null) {
  ...
  /**
   * Get the offset from the CB-register of the first instruction of this function.
   *
  ...
  /**
   * Set the offset from the CB-register of the first instruction of this function.
   *
