...
public class SwitchStatement extends Statement {
  ...
  public String dump() {
    ...
    for (SingleCase actCase : cases) sb.append(actCase.dump()).append("\n");
    for (SingleCase defaultC : defaultCases) sb.append(defaultC.dump()).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
  ...
  public boolean equals(Object o) {
    ...
    if (testExpression != null
        ? !testExpression.equals(that.testExpression)
        : that.testExpression != null) return false;
    if (cases != null ? !cases.equals(that.cases) : that.cases != null) return false;
    return defaultCases != null
        ? defaultCases.equals(that.defaultCases)
        : that.defaultCases == null;
  }
