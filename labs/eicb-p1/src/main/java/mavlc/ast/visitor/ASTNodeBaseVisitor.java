...
/**
 * Basic visitor implementation. Each visit-method calls the visit method of the corresponding
 * super-type.
 *
...
public class ASTNodeBaseVisitor<RetTy, ArgTy> implements ASTNodeVisitor<RetTy, ArgTy> {
  ...
  @Override
  public RetTy visitRecordElementDeclaration(
      RecordElementDeclaration recordElementDeclaration, ArgTy obj) {
