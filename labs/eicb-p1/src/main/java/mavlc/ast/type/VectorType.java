...
public class VectorType extends StructType {
  ...
  /**
   * A pseudo-constructor for creating a VectorType which is not written out in the source code and
   * whose dimension was computed by the compiler. When a source expression is available, use the
   * regular constructor and (in contextual analysis) use setDimension() to supply the result of
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(elemType, that.elemType) && dim.intValue() == that.dim.intValue();
  }
