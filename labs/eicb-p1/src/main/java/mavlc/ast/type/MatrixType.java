...
public class MatrixType extends StructType {
  ...
  /**
   * A pseudo-constructor for creating a Matrix which is not written out in the source code and
   * whose dimensions were computed by the compiler. When a source expression is available, use the
   * regular constructor and (in contextual analysis) use setxDimension() and setyDimension() to
   * supply the results of evaluating those expressions.
   *
